-- ═══════════════════════════════════════════════════════════════════════════
-- v277 — EVENT OPERATIONS WORKSPACE · READ MODEL. A single compositional READ
-- projection (I-34/37) — no new tables, no stored summary, no new write ceremony.
-- It assembles the seven workspace sections entirely from the certified v275/v276
-- authoritative relations and derivations (event, obligation, execution_evidence,
-- obligation_state, event_stage, event_stage_detail). "One derivation, many
-- renderings": the workspace UI renders THIS; it computes nothing itself.
--
--   event_workspace(uuid) → { header, lifecycle, readiness_by_category,
--                             workboard, blockers, next_actions, recent_activity }
--
-- Pre-service kinds = culinary_prepare, equipment_pull, staffing_assign,
-- venue_setup (must be resolved for readiness/service). Post-service =
-- venue_breakdown. Everything is derived; nothing is stored.
-- ═══════════════════════════════════════════════════════════════════════════
